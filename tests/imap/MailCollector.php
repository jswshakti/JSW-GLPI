...
class MailCollector extends DbTestCase
{
     ...
     */
    public function testExtractValuesFromRefHeader(string $message_id, ?array $values)
    {
        $this->newTestedInstance();

        $this->variable($this->callPrivateMethod($this->testedInstance, 'extractValuesFromRefHeader', $message_id))->isEqualTo($values);
    }
