...
final class CustomAssetController extends AbstractController
{
    ...
    public function search(Request $request): Response
    {
        ...
        return Search::searchBySchema($this->getKnownSchema('CustomAsset_' . $itemtype), $request->getParameters());
    }
    ...
    {
        $itemtype = $request->getAttribute('itemtype');
        return Search::getOneBySchema($this->getKnownSchema('CustomAsset_' . $itemtype), $request->getAttributes(), $request->getParameters());
    }
    ...
    {
        $itemtype = $request->getAttribute('itemtype');
        return Search::createBySchema($this->getKnownSchema('CustomAsset_' . $itemtype), $request->getParameters() + ['itemtype' => $itemtype], [self::class, 'getItem']);
    }
    ...
    {
        $itemtype = $request->getAttribute('itemtype');
        return Search::updateBySchema($this->getKnownSchema('CustomAsset_' . $itemtype), $request->getAttributes(), $request->getParameters());
    }
    ...
    {
        $itemtype = $request->getAttribute('itemtype');
        return Search::deleteBySchema($this->getKnownSchema('CustomAsset_' . $itemtype), $request->getAttributes(), $request->getParameters());
    }
