...
if (!$DB->tableExists('glpi_profiles_savedsearches')) {
    $query = "CREATE TABLE `glpi_profiles_savedsearches` (
    ...
    $DB->doQueryOrDie($query, "add table glpi_profiles_savedsearches");
}
